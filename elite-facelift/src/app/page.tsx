  ...
  return (
    <main ref={containerRef} className="bg-[#0A0A0A] text-white selection:bg-blue-600 selection:text-white pb-32 font-sans">
      ...
      <section id="work" className="relative z-20 bg-[#0A0A0A] px-4 md:px-8 max-w-[1800px] mx-auto py-32">
        ...
        {/* ROW 1: Project 01 */}
        <div className="flex flex-col xl:flex-row gap-4 mb-32 relative group">
          <div className="absolute top-0 left-0 z-20 w-full p-4 md:p-8 pointer-events-none flex justify-between items-start">
            <div>
              ...
              <div className="bg-black/30 backdrop-blur-lg border border-white/10 p-6 md:p-8 max-w-xl pointer-events-auto mt-8 shadow-2xl">
          ...
          <div className="hidden xl:block w-1/4 bg-transparent h-[500px] md:h-[700px]" />
          
          <a href="https://yash-study-hub-app.vercel.app" target="_blank" rel="noreferrer" className="w-full xl:w-3/4 h-[500px] md:h-[700px] relative overflow-hidden bg-zinc-900 grayscale group-hover:grayscale-0 transition-all duration-700 block cursor-pointer">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 mb-32">
          ...
          <div className="relative group">
            <div className="absolute top-0 left-0 z-20 w-full p-6 pointer-events-none">
              ...
              <div className="bg-black/30 backdrop-blur-lg border border-white/10 p-6 max-w-md pointer-events-auto mt-6 shadow-2xl">
            ...
            <a href="https://github.com/Astitwa2006/AI-WEBSCRAPER" target="_blank" rel="noreferrer" className="block w-full h-[600px] md:h-[800px] relative overflow-hidden bg-zinc-900 grayscale group-hover:grayscale-0 transition-all duration-700 mt-32">
          ...
          {/* Project 03 */}
          <div className="relative group">
            <div className="absolute bottom-0 left-0 z-20 w-full p-6 pointer-events-none translate-y-1/2 xl:translate-y-0">
              <h2 className="text-5xl md:text-[7rem] font-[family-name:var(--font-anton)] leading-[0.85] tracking-tight uppercase text-white mix-blend-difference mb-4">
                03. DISCORD BOT
              </h2>
              <div className="bg-black/30 backdrop-blur-lg border border-white/10 p-6 max-w-md pointer-events-auto mt-6 shadow-2xl">
            ...
            <a href="https://github.com/Astitwa2006/AI-DISCORD-BOT" target="_blank" rel="noreferrer" className="block w-full h-[600px] md:h-[800px] relative overflow-hidden bg-zinc-900 grayscale group-hover:grayscale-0 transition-all duration-700">
        ...
        {/* ROW 3: Project 04 */}
        <div className="flex flex-col xl:flex-row-reverse gap-4 relative group">
          <div className="absolute top-8 left-0 z-20 w-full p-4 md:p-8 pointer-events-none text-right flex flex-col items-end">
            <h2 className="text-6xl md:text-[10rem] font-[family-name:var(--font-anton)] leading-[0.85] tracking-tight uppercase text-white mix-blend-difference mb-4">
              04. DASHBOARD
            </h2>
            <div className="bg-black/30 backdrop-blur-lg border border-white/10 p-6 md:p-8 max-w-xl pointer-events-auto mt-8 shadow-2xl text-left">
              <div className="flex flex-wrap gap-4 uppercase tracking-widest font-sans text-xs font-bold mb-6 justify-end">
              ...
              <p className="text-sm text-white/90 font-sans leading-relaxed text-right">
              ...
              <div className="mt-8 grid grid-cols-2 gap-x-8 gap-y-6 text-[10px] md:text-xs font-mono uppercase tracking-widest text-zinc-400 text-right">
                <div><span className="text-white font-bold block mb-1">Role</span> Full-Stack Developer</div>
          ...
          <a href="https://github.com/Astitwa2006/Automation-Dashboard" target="_blank" rel="noreferrer" className="block w-full xl:w-[70%] h-[600px] md:h-[800px] relative overflow-hidden bg-zinc-900 grayscale group-hover:grayscale-0 transition-all duration-700 mt-32 xl:mt-0 xl:absolute xl:top-1/2 xl:-translate-y-1/2 xl:left-0">
